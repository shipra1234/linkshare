...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div style="margin-right:50px">
            <g:actionSubmitImage class="message" value="message" src="${resource(dir:'images',file:'link.jpeg')}" id="modal1"/>
             <g:actionSubmitImage class="message" value="message" src="${resource(dir:'images',file:'topic.jpeg')}" id="modal2"/>
            <g:actionSubmitImage class="message" value="message" src="${resource(dir:'images',file:'message.jpeg')}" id="modal3"/>
        </div>
        <div id="n">
        ...
        <div class="modal-content">
            ...
            <g:form action="createLink" controller="resource">
                <div class="modal-body">
                    ...
                    <g:textArea name="description" rows="3" cols="8"/><br/>
                    <label>Topic:*</label>
                    <g:select from="${linksharing.Topic.list()}" name="topic.id" optionValue="name" optionKey="id" noSelection="['Select':'SelectanOption']"/>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <g:submitButton name="Save" class="btn btn-default"/>
